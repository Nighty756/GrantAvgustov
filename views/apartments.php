...
<section class="aparts_block">
    <div class="aparts_container container">
        ...
        <div class="apparts_btn">
                    <a href="<?php echo BASE_URL . "create-apartment.php"?>" class="add-btn" type="button">Добавить</a>
                </div>
...
<tr>
    ...
    <td><a class="edit-link" href="edit.php?id=<?= $apart['id']; ?>">Изменить</a></td>
    <td><a class="del-link" href="edit.php?del_id=<?= $apart['id']; ?>">Удалить категорию</a></td>
</tr>
</tbody>
<?php endforeach; ?>
</table>
