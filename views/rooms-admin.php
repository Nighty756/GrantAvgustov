...
<section class="aparts_block">
    <div class="aparts_container container">
        <h1 class="aparts_title title_block">Управление номерами</h1>
...
<tr>
    ...
    <td><a class="edit-link" href="edit-room.php?id_room=<?= $room['id']; ?>">Изменить</a></td>
    <td><a class="del-link" href="edit-room.php?delroom_id=<?= $room['id']; ?>">Удалить номер</a></td>
</tr>
</tbody>
<?php endforeach; ?>
</table>
